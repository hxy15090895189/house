    ...
    <script language="JavaScript">
            ...
            $('#dg').datagrid({
                ...
                columns: [[
                    ...
                    { field: 'opt', title: '操作', width: 50, align: "center",
                        ...
                        //同步 "<a href='deletDistrict?id="+row.id+"'>删除</a>"
                            //异步请求
      ...
      //删除单个区域
        function delSingle(id) {
            $.messager.confirm('提示框', '请确认删除?', function(r){
                if (r){
                    //$.post("服务器地址",给服务器传参，回调函数，"json");
                    //传参的格式：{"参数名称":值,参数名称":值,}（注意：参数名称必须与控制器的参数名称保持一致）
                    $.post("deletDistrict",{"id":id},function (data) {
                        if(data.w>0){
                            $("#dg").datagrid('reload'); //刷新数据(自动刷新）
                            //alert("添加成功");
